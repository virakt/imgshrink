...
import (
    "fmt"
    "github.com/imgshrink/internal/api"
    "github.com/imgshrink/internal/compressor"
)
...
func main() {
    ...
    result, err := imageAPI.CompressImage("input.jpg", options)
    if err != nil {
        panic(err)
    }
...
│   │   └── api.go            # API layer
│   ├── compressor/
│   │   ├── compressor.go     # Core compression interface
│   │   ├── jpeg.go           # JPEG compression
│   │   └── png.go            # PNG compression
│   └── tui/
│       ├── app.go            # Main TUI application
│       ├── styles.go         # Lip Gloss styles
│       └── views/
│           ├── home.go       # File selection view
│           ├── options.go    # Options view
│           ├── progress.go   # Progress view
│           └── result.go     # Results view
├── go.mod
├── go.sum
└── README.md
```
